          ...
          >
            ...
            >
              <svg
                ...
                className="h-12 w-12 bg-violet-500"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            >
              <NavbarLink href="/usuarios" title=" ususario" />
              <NavbarLink href="/salidas" title=" salida" />
              <NavbarLink href="/entradas" title=" entrada" />
              <NavbarLink href="/gestion" title=" gestion" />
            </ul>
  ...
  return (
    <li role="none" className="flex items-stretch">
      <Link
        ...
        className={`flex items-center gap-2 py-4 transition-colors focus:text-violet-600 duration-300 lg:px-8 focus-visible:outline-none  focus:outline-none 
                  ${
                    isActive
